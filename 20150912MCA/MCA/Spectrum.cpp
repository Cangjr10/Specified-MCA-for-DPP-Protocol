...
{
	AfxMessageBox(_T("CSpectrum::SetSpectrumData！"));
}
}//重置谱数据
...
{
	AfxMessageBox(_T("CSpectrum::GetSpectrumMax！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::AddROI！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::DeleteROI！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::GetROIMax！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::GetROIMin！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::GetElement！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::GetElement_LiveSpectrumData！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::GetElement_IntrinsicSpectrumData！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::GetElement_RebinedIntrinsicSpectrum！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::GetElement_RebinedLiveSpectrum！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::GetElement_SNIP_Background！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::GetEnergy！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::GetSelectedROIIndex！"));
}
...
try{
	...
	{
		AfxMessageBox(_T("CSpectrum::Background1General！"));
	}
}
...
try{
	...
	int size1 = (int)ceil(3000.0/width);
	energy_out.resize(0);
...
{
	AfxMessageBox(_T("CSpectrum::Rebin！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::Smooth！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::polyfit2_3！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::polyfit2_4！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::SearchMaxPosition！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::swap！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::DirectLU！"));
}
}
...
{
	AfxMessageBox(_T("CSpectrum::Preprocess！"));
}
// 	if (Cs_activity > 0.2)
// 	{
// // 		CWaringDlg warning;
...
try{
	...
	if (nuclide == Cs137)//RebinedSpectrum是并道之后的谱数据，1000道
	{
		...
		for (int i=(int)ceil((Energy_Centroid-PeakArea_sigma*sigma/2)/BinWidth);i<(int)floor((Energy_Centroid+PeakArea_sigma*sigma/2)/BinWidth);i++)
		{
...
{
	AfxMessageBox(_T("CSpectrum::CalculateActivity！"));
}
}